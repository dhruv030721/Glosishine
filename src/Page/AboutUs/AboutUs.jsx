    ...
    <div className="w-full min-h-screen bg-gray-50 flex justify-center py-12 px-4">
      <div className="w-full max-w-4xl">
        ...
        <div data-aos="fade-up" data-aos-duration="1000" className="space-y-8">
          ...
          <h1 className="text-xl font-bold font-signika">Diversity </h1>
          <p className="p-1 font-signika">
          ...
          <h1 className="text-xl font-bold font-mpoppinsmt-5">
          ...
          <h1 className="p-3 font-mpoppinsmt-5">
