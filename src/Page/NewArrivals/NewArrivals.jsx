...
const NewArrivals = () => {
  return (
    <div className='w-full'>
      <div className='w-full pl-10 flex flex-row h-10 items-center gap-x-3 font-serif'>
        <Link to='/'>
          Home
        </Link>
      ...
      <h1 className='w-full mt-5 font-semibold font-serif text-2xl pl-12'> New Arrivals</h1>
      <div className='p-7'>
            ...
            <div data-aos="fade-zoom-in"
              ...
              <div className="flex flex-col overflow-hidden">
                ...
                <div className="mt-4 ">
                  ...
                  <div className="mt-2 mb-5 flex items-center justify-between">
                    <p className='w-full flex justify-evenly'>
                      <span class="text-sm text-black font-bold line-through">Rs. 1,470.00</span>
                      <span className="text-sm text-green-700 font-bold text-bleck">Rs. 1,299.00</span>
                    </p>
                  </div>
                </div>
