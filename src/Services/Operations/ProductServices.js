...
import { productendpoints, reviewendpoints } from "../Apis"
...
export async function addProduct({ productData }) {
    ...
    const response = await apiConnector("POST", productendpoints.ADDPRODUCTS_API, formData);
    return response;
...
export async function updateProduct(data, id) {
    ...
    const response = await apiConnector("POST", productendpoints.UPDATEPRODUCT_API, formData);
    return response;
}

export async function deleteProduct(productid) {
    // console.log(productid);
    const response = await apiConnector("GET", productendpoints.DELETEPRODUCT_API + productid);
    return response;
}
...
export async function addReview(data, id, rating) {
    ...
    const response = await apiConnector("POST", reviewendpoints.ADDREVIEW_API, formdata);
    return response;
}


export async function getReview(id) {
    const response = await apiConnector("GET", reviewendpoints.GETREVIEW_API + id);
    return response;
}
