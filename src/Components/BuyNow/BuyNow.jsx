    ...
    <>
      <React.Fragment>
        <button
          ...
          className="bg-bg-green px-10 py-3 text-white uppercase tracking-widest cursor-pointer rounded-lg border-2 border-dashed border-bg-green shadow-[0_2px_5px_-1px_rgba(50,50,93,0.25),0_1px_3px_-1px_rgba(0,0,0,0.3)] transition duration-400 hover:bg-white hover:text-bg-green active:bg-bg-green"
        >
          Buy Now
        </button>
        <Dialog
            ...
            <div className="h-full max-w-[350px] bg-gray-100 flex items-center flex-col justify-center">
                  ...
                  >
                    ...
                    <div className="text-gray-500">
                      <p className={dropdownVisible ? "hidden" : "block"}>
                        <RiArrowDownSLine className="mt-1 ml-36" size={20} />
                      </p>
                      <p className={dropdownVisible ? "block" : "hidden"}>
                        {" "}
                        <RiArrowUpSLine className="mt-1 ml-36" size={20} />
                      </p>
                    </div>
                  </button>
                </div>
                {dropdownVisible && (
                  <>
                    ...
                    <div className="px-6 py-4 bg-gray-100 border-t text-sm">
                      <button
                        className="w-full py-2 bg-gray-200 text-gray-800 font-semibold rounded-lg"
                        onClick={handleShopClick}
                      >
                        Close
                      </button>
              ...
              {first && (
                <div className="mt-4 w-full p-3">
                  <button
                    className="flex flex-row  items-center bg-white p-3 rounded-lg "
                  ...
                  <div className="mt-4">
                    ...
                    />
                    <button
                      className="cursor-pointer mt-3 group relative flex gap-1.5 p-2 items-center justify-center w-full h-12 bg-green-900 bg-opacity-80 text-[#f1f1f1] rounded-lg hover:bg-opacity-70 transition font-semibold shadow-md"
                ...
                <div className="flex items-center w-full mt-8 justify-center bg-gray-100">
                  <div className="bg-white p-5 rounded shadow-md w-full max-w-md">
                    ...
                    <form>
                      <div className="mb-4">
                        <label
                          className="block text-gray-700 font-semibold mb-1 text-[12px]"
                          htmlFor="fullName"
                        >
                          Full Name*
                        </label>
                    ...
                    <div className="mt-2 text-center text-gray-500 text-[12px] flex ">
                      Secure checkout by{" "}
                      <span className="font-semibold">🛡 Simpl</span>
                    </div>
                  </div>
                </div>
              )}
                    ...
                    <div className="border-2 border-gray-300 rounded-md flex mt-2 flex-col">
                      ...
                      <div className="p-3 flex flex-row items-center gap-x-32">
                        <div>
                          ...
                          <h1 className="text-[11px] font-semibold text-gray-700 ml-1 ">
